...
export function Doodle({ type, color, size, top, left, rotate }) {
  const style = {
    position: 'absolute',
    top: `${top}%`,
    left: `${left}%`,
...
function generarDoodles() {
  return [
    ...generarGrupo(20, [0, 30], [10, 22]),
    ...generarGrupo(20, [70, 100], [10, 22]),
    ...generarGrupo(18, [0, 100], [30, 60]),
    ...generarGrupo(10, [0, 30], [16, 30]),
  ]
}
